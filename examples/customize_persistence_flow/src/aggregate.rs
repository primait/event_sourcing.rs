...
//
// #[async_trait]
// impl AggregateManager<A> for CounterAggregate {
...
//     }
//
//     // TODO: aggregate manager should be refactored and need to add another function like `store_event_with_fn` or something similar
